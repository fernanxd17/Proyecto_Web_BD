...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">VentaCOL</span> <small style="color: #fff;">Online</small></h1>
      <p>
          Bienvenid@ a nuestra tienda en linea, aquí encontras una gran variedad de artículos de belleza, nutricion, hogar, y muchas mas.
      </p>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">VentaCOL</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-block">Registrarse</a></p>   
                   </article>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/seccionRegistro.png" alt="Smart-TV" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
