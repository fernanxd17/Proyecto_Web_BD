...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2017 a las 15:31:01
...
CREATE TABLE `administrador` (
  `Cod_admin` varchar(3) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  ...
  `Id_departamento` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Id_municipio` varchar(4) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `administrador` (`Cod_admin`, `Cedula`, `Apellidos`, `Nombres`, `F_nacimiento`, `Telefono`, `Celular`, `Id_departamento`, `Id_municipio`, `F_ingreso`, `Email`, `Password`) VALUES
('001', '123456789', 'Romero', 'Fernando', '1997-01-17', '5452365', '3334585545', '', '', '2017-11-01', 'admin@hotmail.com', 'admin');
...
CREATE TABLE `carrito` (
  `Id_Pedido` varchar(8) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cod_cliente` varchar(7) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cod_Producto` varchar(3) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `cliente` (
  ...
  `Apellidos` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Nombres` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `F_nacimiento` varchar(10) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Telefono` varchar(7) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Celular` varchar(10) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Id_departamento` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Id_municipio` varchar(4) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `cliente` (`Cod_cliente`, `Cedula`, `Apellidos`, `Nombres`, `F_nacimiento`, `Telefono`, `Celular`, `Id_departamento`, `Id_municipio`, `Email`, `Password`) VALUES
(1, '6039857575', 'Murillo', 'Diosa', '2017-11-20', '5666666', '3189999999', '20', '1042', 'juanfernandoro@ufps.edu.co', '12345678'),
(2, '1090502664', 'Romero Ortega', 'Juan Fernando', '2009-02-10', '5777777', '3000000000', '54', '275', 'juanfernandoro@ufps.edu.co', '12345678');
...
CREATE TABLE `compra` (
  `Id_compra` varchar(8) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cod_cliente` varchar(7) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Id_municipio` varchar(4) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Direccion` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Id_forma` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `departamentos` (
  ...
  `departamento` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
...
CREATE TABLE `forma_pago` (
  `Id_forma` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `forma` varchar(25) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pedido` (
  ...
  `Cod_producto` varchar(10) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cod_cliente` varchar(7) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `producto` (
  ...
  `Tipo_Producto` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Descripcion` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cant_Disponible` int(4) NOT NULL,
...
INSERT INTO `producto` (`Cod_producto`, `Nombre`, `Marca`, `Precio`, `Tipo_Producto`, `Descripcion`, `Cant_Disponible`, `Imagen`) VALUES
('001', 'Complejo Natural B (90 tabletas)', 'Nutrilite', 35000, '02', 'Este suplemento contiene las propiedades de siete Vitaminas del Complejo B (B12, B6, B2, B1, B5, B3), las mismas que se recomiendan consumir de manera regular por ser eliminadas del cuerpo diariamente', 10, 'complejob.jpg'),
('002', 'Omega 3 (90 capsulas)', 'Nutrilite', 91800, '02', ' ofrece una fÃ³rmula exclusiva con grasas necesarias provenientes Omega 3, de origen natural y sin e', 10, 'omega.jpg'),
('003', 'Phytopowder sabor Cereza', 'Powder', 123100, '02', 'Fortalece las defensas de tu cuerpo con45mg de Vitamina C y 4,5 mg de Zinc.', 10, 'tecero.jpg'),
('004', 'LociÃ³n Hidratante', 'Moiskin', 53700, '03', 'Para pieles maduras. Paso 2: Tonificar', 10, 'cuarto.jpg'),
('005', 'Vestido Salomon Azulu', 'Salomon Azulu', 100000, '01', 'Vestido con estampado etnico', 5, 'quinta.jpg'),
('006', 'Ropa de Ejercicio', 'Nike', 60000, '01', 'Camiseta licrada color cereza con amarillo, cuello V. Marca Nike. Dimensiones: 35 cm de busto, 33 cm', 5, 'sexta.JPG'),
('112', 'jabon', 'ariel', 545, '03', 'jajdfa', 4, 'valley-catholic-high-school-logo-2.png'),
('123', 'ajsdf', 'assaas', 3444, '02', 'asssssssssssssssss', 4, 'valley-catholic-high-school-logo-2.png');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `subcompra`
--

CREATE TABLE `subcompra` (
  `Id_subcompra` varchar(8) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cod_Producto` varchar(3) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Cantidad` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `PrecioTotal` varchar(8) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Id_compra` varchar(8) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tipo_producto` (
  `id_tipo` varchar(2) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
--
ALTER TABLE `pedido`
  ADD PRIMARY KEY (`Id_pedido`,`Cod_producto`,`Cod_cliente`),
  ADD KEY `Id_pedido` (`Id_pedido`,`Cod_producto`,`Cod_cliente`),
...
--
-- Indices de la tabla `subcompra`
--
ALTER TABLE `subcompra`
  ADD PRIMARY KEY (`Id_subcompra`,`Id_compra`),
  ADD KEY `Id_subcompra` (`Id_subcompra`,`Cod_Producto`),
...
--
ALTER TABLE `compra`
  ADD CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`Id_municipio`) REFERENCES `municipios` (`id_municipio`) ON UPDATE CASCADE,
  ADD CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`Id_forma`) REFERENCES `forma_pago` (`Id_forma`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`Cod_producto`) REFERENCES `producto` (`Cod_producto`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`Tipo_Producto`) REFERENCES `tipo_producto` (`id_tipo`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `subcompra`
--
ALTER TABLE `subcompra`
  ADD CONSTRAINT `subcompra_ibfk_1` FOREIGN KEY (`Id_compra`) REFERENCES `compra` (`Id_compra`) ON UPDATE CASCADE,
  ADD CONSTRAINT `subcompra_ibfk_2` FOREIGN KEY (`Cod_Producto`) REFERENCES `producto` (`Cod_producto`) ON UPDATE CASCADE;
COMMIT;
