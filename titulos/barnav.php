...
<script type=text/javascript>
  ...
  $(document).ready(function(){
    ...
    $('section').on('click','#items #confirmar', function(){
     
      <?php
    $cant = $_SESSION['contador'];
       
      if($_SESSION['contador']==0){

      echo 'alert("no ha añadido productos al carrito");';
       
      }else{
       
        echo 'window.location="pedido.php";';
...
<script type=text/javascript>
  ...
  $(document).ready(function(){
    ...
    $('nav').on('click','#opciones #pedido', function(){
...
<section id="container-carrito-compras">
    <div class="container">
        <div class="row">
            ...
            <div id="items" class="col-xs-12 col-sm-6">
                <p class="text-center" style="font-size: 80px;">
                    <i class="fa fa-shopping-cart"></i>
                </p>
                <p class="text-center">
                    <a   id="confirmar"  href="#" class="btn btn-success btn-block"><i class="fa fa-dollar"></i>   Confirmar pedido</a>

                    <a id="vaciar" href="controller/vaciarcarrito.php" class="btn btn-danger btn-block"><i class="fa fa-trash"></i>   Vaciar carrito</a> 
                </p>
            </div>
        </div>
    </div>
...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu computadoras y tablets -->
            <div class="col-xs-4">
               <i class="fa fa-vimeo" aria-hidden="true"></i>
                ...
                <p class="text-navbar tittles-pages-logo">VentaCOL</p>
            </div>
            <div class="col-xs-8">
                <div class="contenedor-tabla pull-right">
                    <div id ="opciones" class="contenedor-tr">
                        ...
                        <a href="product.php" class="table-cell-td">Catalogo</a>
                            ...
                            if(!$_SESSION['nombreAdmin']==""){
                                ...
                                echo ' 
                                    ...
                                    <a id="pedido" href="#"  class="table-cell-td">Pedido</a>
                                    <a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                                        <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
                                    </a>
                                    <a href="#" class="table-cell-td" data-toggle="modal" data-target=".modal-logout">
                                    ...
                                    <a href="contacto.php" class="table-cell-td">Contáctenos</a>
                                 ';
                            }else{
                                echo ' 
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en VentaCOL</h4>
                </div>
               
            <form action="controller/login.php" method="post" role="form" style="margin: 20px;" class="FormCatElec" data-form="login">
                  <div class="form-group">
                      <label><span class="glyphicon glyphicon-user"></span>&nbsp;Email</label>
                      <input type="email" class="form-control" name="email-login" placeholder="Escribe su email" required=""/>
                  </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">VentaCOL</h3>
    ...
    <div class="modal fade modal-logout" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="padding: 20px;">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <p class="text-center">
                <a href="controller/logout.php" class="btn btn-primary btn-sm">Cerrar la sesión</a>
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Cancelar</button>
            </p>
          </div>
      </div>
